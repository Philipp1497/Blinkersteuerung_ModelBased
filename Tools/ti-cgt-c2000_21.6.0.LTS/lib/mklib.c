...
library_t LIBRARIES[] = {
    { "rts2800_fpu64_eabi.lib", { "GENERIC_MATH_COMMON","CLA_MATH","IDIV","GENERIC_MATH_COMMON_DOUBLE","FPU64","EABI","GENERIC_MATH_COMMON_FLOAT","GENERIC_MATH_COMMON_64BIT","GENERIC_MATH_COMMON_32BIT","C28EABI" } },
    { "rts2800_fpu64_eabi_eh.lib", { "GENERIC_MATH_COMMON_64BIT","IDIV","FPU64","EXCEPTIONS","C28EABI","GENERIC_MATH_COMMON_32BIT","GENERIC_MATH_COMMON_FLOAT","EABI","EABI_TDEH","CLA_MATH","GENERIC_MATH_COMMON_DOUBLE","GENERIC_MATH_COMMON" } },
    { "rts2800_ml_eabi_eh.lib", { "EXCEPTIONS","GENERIC_MATH_COMMON_32BIT","C28EABI","LARGE","EABI","GENERIC_MATH_COMMON_FLOAT","EABI_TDEH","DOUBLE_DIV_NOFPU64","CLA_MATH","GENERIC_MATH_COMMON_DOUBLE","GENERIC_MATH_COMMON","GENERIC_MATH_COMMON_64BIT" } },
    { "rts2800_fpu32_eh.lib", { "DOUBLE_DIV_NOFPU64","FULL_PORTABLE_EH","FPU32","EXCEPTIONS" } },
    { "rts2800_fpu32_eabi.lib", { "GENERIC_MATH_COMMON","DOUBLE_DIV_NOFPU64","CLA_MATH","GENERIC_MATH_COMMON_DOUBLE","EABI","GENERIC_MATH_COMMON_FLOAT","FPU32","C28EABI","GENERIC_MATH_COMMON_32BIT","IDIV","GENERIC_MATH_COMMON_64BIT" } },
    { "rts2800_fpu32_eabi_eh.lib", { "GENERIC_MATH_COMMON_64BIT","IDIV","C28EABI","GENERIC_MATH_COMMON_32BIT","EXCEPTIONS","FPU32","GENERIC_MATH_COMMON_FLOAT","EABI","GENERIC_MATH_COMMON_DOUBLE","EABI_TDEH","CLA_MATH","DOUBLE_DIV_NOFPU64","GENERIC_MATH_COMMON" } },
    { "rts2800_ml_eabi.lib", { "GENERIC_MATH_COMMON_64BIT","GENERIC_MATH_COMMON_FLOAT","EABI","LARGE","GENERIC_MATH_COMMON_32BIT","C28EABI","GENERIC_MATH_COMMON","GENERIC_MATH_COMMON_DOUBLE","DOUBLE_DIV_NOFPU64","CLA_MATH" } },
    { "rts2800_ml_eh.lib", { "EXCEPTIONS","FULL_PORTABLE_EH","LARGE","DOUBLE_DIV_NOFPU64" } },
    { "rts2800_fpu32.lib", { "FPU32","DOUBLE_DIV_NOFPU64" } },
